...
const EyeOffIcon = ({ size = 20 }) => (
    <svg
        ...
        strokeWidth={2}
    >
        <path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a21.72 21.72 0 015.06-6.94M9.9 4.24A9.91 9.91 0 0112 4c7 0 11 8 11 8a21.58 21.58 0 01-2.88 3.88M1 1l22 22" />
    </svg>
);
