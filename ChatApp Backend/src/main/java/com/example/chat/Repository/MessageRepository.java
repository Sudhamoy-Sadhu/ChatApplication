...
public interface MessageRepository extends JpaRepository<Message, Long> {
        ...
        @Query("""
                            ...
                            WHERE m.senderId <> :userId
                              ...
                              AND :userId NOT MEMBER OF m.readByUserIds
                        """)
        List<Long> findSendersWithPendingDeliveries(@Param("userId") Long userId);
        ...
        @Query("SELECT DISTINCT m FROM Message m " +
                        ...
                        "LEFT JOIN FETCH m.deliveredToUserIds " +
                        "WHERE m.roomId = :roomId " +
                        "AND m.sentAt > :minDate " +
                        "ORDER BY m.sentAt ASC")
        List<Message> findByRoomIdWithReceiptsAfter(@Param("roomId") Long roomId,
